...
import {FeedbackService} from '@app/main/_services/feedback.service';
...
export class FeedbackComponent implements OnInit {
  ...
  loadAdminPracticeVideos() {
    this.feedbackService.getAdminPracticeVideo().subscribe((value => {
      console.log(value);
    }));
  }

...
export class VideoRecordingService {
  ...
  private record(): void {
    ...
    this.interval = setInterval(
      () => {
        ...
        const time = diffTime.asSeconds().toString();
  ...
  stopRecording() {
    if (this.recorder) {
      console.log('test', this.processVideo.bind(this));
  ...
  private processVideo(audioVideoWebMURL) {
    ...
    console.log(recordedBlob, audioVideoWebMURL);
